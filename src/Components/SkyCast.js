	...
	return ( 
		<div className="App"> 
			...
			{weather.error && ( 
				...
				<p className=' text-gray-800 text-center mt-5'>Web Designed by <a href='https://github.com/er-arunkumarselvam' target='_blank' rel="noreferrer" className='underline underline-offset-2 font-semibold text-gray-950' >Arunkumar.</a> </p>
				</div>
			)} 
